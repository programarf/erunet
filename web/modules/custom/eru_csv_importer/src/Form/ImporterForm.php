...
namespace Drupal\eru_csv_importer\Form;
...
use Drupal\eru_csv_importer\ParserInterface;
use Drupal\eru_csv_importer\Plugin\ImporterManager;
...
class ImporterForm extends FormBase {
   ...
   *   The entity bundle info service.
   * @param \Drupal\eru_csv_importer\Parser\ParserInterface $parser
   *   The parser service.
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('eru_csv_importer.parser'),
